...
def get_datasets():
    ...
    summary = (
        summary.set_index("PO #")
        .pipe(lambda df: df.reindex(df.index))  # preserve order
    )
...
if summary is not None:
    ...
    st.info("Awaiting data. Please ensure the 'Downloads' folder contains CSVs and 'report_controls.xlsx' is in the repository root.")import streamlit as st
import pandas as pd
import numpy as np
from pathlib import Path
import io
